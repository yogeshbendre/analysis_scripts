...
python service_tomcat_component_times.py -f /var/log/vmware/vapi/monitoring/SYSTEM-LEVEL-UTILIZATION/ -d ../ -s sps > /var/log/vmware/spsout_analysis.txt 2> /var/log/vmware/spsout_analysis.txt
python service_tomcat_component_times.py -f /var/log/vmware/vapi/monitoring/SYSTEM-LEVEL-UTILIZATION/ -d ../ -s content-library > /var/log/vmware/clsout_analysis.txt 2> /var/log/vmware/clsout_analysis.txt
